...
- СТРОГО ЗАПРЕЩЕНО переименовывать или переклассифицировать модели. Класс модели — только из каталога: Эконом, Бюджет, Стандарт, Бизнес, Премиум. Не называй бизнес-класс премиумом и наоборот. Если клиент спрашивает про класс — ссылайся только на то, что было показано в подборке выше.
{power_block}"""
